...
:root {
    ...
    --sidebar-hover-background-color: #d4d4d4;
    --sidebar-active-background-color: #007bff;
    --sidebar-active-text-color: #ffffff;
    --logout-background-color: #b12424;
    --logout-hover-background-color: #cc5447;
}

[data-theme="dark"] {
    --sidebar-background-color: #343a40;
    --sidebar-text-color: #ecf0f1;
    --sidebar-hover-background-color: #007bff;
    --sidebar-active-background-color: #f39c12;
    --sidebar-active-text-color: #ffffff;
...
.logout-btn {
    ...
    background-color: var(--logout-background-color);  /* Red background by default */
}

/* Hover Effects */
.logout-btn:hover {
    background-color: var(--logout-hover-background-color);  /* Darker red on hover */
    padding-left: 30px;
    box-shadow: 0 4px 10px rgba(0, 0, 0, 0.2); /* Darker shadow on hover */
}
    ...
    <aside class="sidebar">
        ...
        <nav class="nav">
            <ul>
                ...
                <li><a href="{{ route('profile') }}"><i class="fa fa-user-cog"></i> Profile</a></li>
            </ul>
        </nav>
